...
In the Python version the first prime pass is an overwrite pass in increasing prime order, so every entry starts as its largest prime factor. Only the higher prime powers need a conditional maximum update afterward.
