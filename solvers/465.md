...
Optional: tune the sieve size (memory vs speed trade-off).  The default is
`30,000,000`; lower values use less memory but leave more work for the recursive
summatory-totient cache:
