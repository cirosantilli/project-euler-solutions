...
The Python implementation keeps the NTT buffers large enough for the full product before truncating, so higher coefficients cannot wrap around into the low degrees during the transform.
